            ...
            <form className={classes.root} onSubmit={SubmitCode}>
              <div className="Ver_container_two">
                ...
                <div className="Var_text">
                  <span>
                    Please provide the verification
                    <br />
                    code sent to confirm
                    <br />
                    delivery
                  </span>
                </div>
      ...
      >
        ...
        <DialogContent style={{ width: "auto", height: "auto" }}>
          ...
          <div className="ver_dialog_text_container">
            <div>
              <div className="ver_header_text">
                <span>Product Name</span>
              </div>
              <div className="ver_product_Name">
                <span>{VerData.order_name}</span>
              </div>
              <div className="ver_Sender_container">
                <div>
                  ...
                  <div className="ver_font_size">
                    <span>{VerData.customer_fullname}</span>
                  </div>
                </div>
                <div>
                  <div className="ver_phone_text">
                    <span>Customer Phone</span>
                  </div>
                  <div className="ver_font_size_phone">
                    <span>{VerData.customer_phone}</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="ver_font_size">
                  <span>{VerData.order_description}</span>
                </div>
              </div>
