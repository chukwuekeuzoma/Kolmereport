      ...
      <Fade>
        {Dloader ? (
          ...
          <div className="Order_container">
            <div>
              <div className="Or_header_text">
                <span>Product Name</span>
              </div>
              <div className="product_Name">
                <span>{orderDetails.order_name}</span>
              </div>
              <div className="Or_Sender_container">
                <div>
                  ...
                  <div className="font_size">
                    <span>{orderDetails.customer_fullname}</span>
                  </div>
                </div>
                <div>
                  <div className="Or_phone_text">
                    <span>Customer Phone</span>
                  </div>
                  <div className="font_size_phone">
              ...
              <div>
                ...
                <div className="font_size">
                  <span>{orderDetails.order_description}</span>
                </div>
              </div>
